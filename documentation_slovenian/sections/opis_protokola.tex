Sam protol je v JSON formatu in teèe preko Bluetooth Serial Port ter je zelo enostaven. V trenutni verziji je podprta samo enosmerna komunikacija, saj potrebe po dvosmerni komunikaciji (zaenkrat) ni bilo.
...
\begin{lstlisting}[caption=Oblika formata za MOUSE mode]
{
   "mouse":{
      ...
      "middlebutton":"buttonStateMiddle",
...
\end{lstlisting}
\textbf{Razlaga:}\newline
key = tipka, ki naj bi bila pritisnjena na raèunalniški tipkovnici. Posebni znaki morajo biti zapisani s 
polnim imenom (npr. "). 
modifiers = v array se navede katere tipke so dodatno še pritisnjene. Npr. za veliki A moramo dodati v 
